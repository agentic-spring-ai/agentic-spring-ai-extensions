# Agentic AI Elasticsearch Memory Module

[中文版本](README-zh.md)

## Introduction

The Spring AI Alibaba Elasticsearch Memory Module is a core component of the Agentic AI project,
...
<dependency>
    ...
    <artifactId>agentic-ai-starter-model-chat-memory-repository-elasticsearch</artifactId>
...
import io.github.agentic-ai.chat.memory.repository.elasticsearch.ElasticsearchChatMemoryRepository;
