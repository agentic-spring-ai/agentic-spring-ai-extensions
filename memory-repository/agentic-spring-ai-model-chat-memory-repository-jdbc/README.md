...
<dependency>
    <groupId>io.github.agentic.spring.ai</groupId>
    <artifactId>agentic-spring-ai-starter-model-chat-memory-repository-jdbc</artifactId>
    <version>${latest.version}</version>
</dependency>
```
...
import io.github.agentic.spring.ai.memory.jdbc.MysqlChatMemoryRepository;
