...
<dependency>
    <groupId>io.github.agentic-ai</groupId>
    <artifactId>agentic-ai-starter-model-chat-memory-repository-mongodb</artifactId>
    <version>${latest.version}</version>
</dependency>
```
