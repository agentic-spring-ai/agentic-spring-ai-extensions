...
> Refer to [Mem0 example](https://github.com/springaialibaba/agentic-spring-ai-examples/agentic-spring-ai-mem0-example/README.md)。
> Dependency Reference
```xml
<dependency>
    <groupId>io.github.agentic.spring.ai</groupId>
    <artifactId>agentic-spring-ai-starter-memory-mem0</artifactId>
