...
<dependency>
    ...
    <artifactId>agentic-spring-ai-autoconfigure-memory</artifactId>
    <version>${latest.version}</version>
</dependency>

<dependency>
    <groupId>io.github.agentic.spring.ai</groupId>
    <artifactId>agentic-spring-ai-starter-model-chat-memory-repository-redis</artifactId>
    <version>${latest.version}</version>
</dependency>
```
...
```java
import io.github.agentic.spring.ai.autoconfigure.memory.redis.*;
...
```java
import io.github.agentic.spring.ai.memory.redis.BaseRedisChatMemoryRepository;
