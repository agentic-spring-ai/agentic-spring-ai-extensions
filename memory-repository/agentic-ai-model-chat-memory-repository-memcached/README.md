...
<dependency>
    <groupId>io.github.agentic-ai</groupId>
    <artifactId>agentic-ai-starter-model-chat-memory-repository-memcached</artifactId>
    <version>${latest.version}</version>
</dependency>
```
...
import io.github.agentic-ai.memory.mongodb.MongoDBChatMemoryRepository;
