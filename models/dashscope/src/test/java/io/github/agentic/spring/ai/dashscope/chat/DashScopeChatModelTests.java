...
import io.github.agentic.spring.ai.dashscope.chat.DashScopeChatModel.Builder;
import io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.ChatCompletion;
import io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.ChatCompletionChunk;
import io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.ChatCompletionFinishReason;
import io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.ChatCompletionMessage;
import io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.ChatCompletionMessage.ChatCompletionFunction;
import io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.ChatCompletionMessage.MediaContent;
import io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.ChatCompletionMessage.ToolCall;
import io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.ChatCompletionOutput;
import io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.ChatCompletionOutput.Choice;
import io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.ChatCompletionRequest;
import io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.SearchOptions;
import io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.SearchInfo;
import io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.SearchResult;
import io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.TokenUsage;
import io.github.agentic.spring.ai.tool.validator.DefaultToolCallValidator;
...
class DashScopeChatModelTests {
    ...
    void testStreamErrorResponse() {
        ...
        when(dashScopeApi.chatCompletionStream(any(), any())).thenReturn(Flux.error(new io.github.agentic.spring.ai.dashscope.common.DashScopeException("InvalidParameter  (requestId: error-request-123)")));

        Flux<ChatResponse> responseFlux = chatModel.stream(prompt);

        StepVerifier.create(responseFlux)
                .expectErrorMatches(throwable ->
                        throwable instanceof io.github.agentic.spring.ai.dashscope.common.DashScopeException
    ...
    void testStreamErrorResponseWithCode() {
        ...
        when(dashScopeApi.chatCompletionStream(any(), any())).thenReturn(Flux.error(
                new io.github.agentic.spring.ai.dashscope.common.DashScopeException("InvalidParameter",
        ...
        StepVerifier.create(responseFlux)
                .expectErrorMatches(throwable ->
                        throwable instanceof io.github.agentic.spring.ai.dashscope.common.DashScopeException
                                && ((io.github.agentic.spring.ai.dashscope.common.DashScopeException) throwable).getCode()
    ...
    void testChatResponseUsageContainsDashScopeNativeUsage() {
        ...
        var cacheCreation = new io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.CacheCreation(1024);
        var promptTokenDetailed = new io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.PromptTokenDetailed(
                128,           // cachedTokens
        ...
        assertThat(response.getMetadata().getUsage()).isInstanceOf(io.github.agentic.spring.ai.dashscope.metadata.DashScopeAiUsage.class);

        var dashScopeUsage = (io.github.agentic.spring.ai.dashscope.metadata.DashScopeAiUsage) response.getMetadata().getUsage();
    ...
    void testCreateRequestWithCacheControlInUserMessage() {
        ...
        List<io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.ChatCompletionMessage.MediaContent> contentList =
                (List<io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.ChatCompletionMessage.MediaContent>) firstMessage.rawContent();
