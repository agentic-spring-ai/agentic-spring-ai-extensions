...
import io.github.agentic.spring.ai.dashscope.rerank.DashScopeRerankModel.Builder;
import io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.RerankResponse;
import io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.RerankResponseOutput;
import io.github.agentic.spring.ai.dashscope.spec.DashScopeApiSpec.RerankResponseOutputResult;
...
class DashScopeRerankModelTests {
	...
	void testSuccessfulRerank() {
		...
		io.github.agentic.spring.ai.model.RerankResponse response = rerankModel.call(request);
