...
import io.github.agentic.spring.ai.dashscope.chat.DashScopeChatApiSpec.CacheCreation;
...
import io.github.agentic.spring.ai.dashscope.chat.DashScopeChatApiSpec.ChatCompletionFunction;
...
import io.github.agentic.spring.ai.dashscope.chat.DashScopeChatApiSpec.ChatCompletionRequest.Parameters.SearchOptions;
import io.github.agentic.spring.ai.dashscope.chat.DashScopeChatApiSpec.MediaContent;
import io.github.agentic.spring.ai.dashscope.chat.DashScopeChatApiSpec.PromptTokenDetailed;
import io.github.agentic.spring.ai.dashscope.chat.DashScopeChatApiSpec.Role;
import io.github.agentic.spring.ai.dashscope.chat.DashScopeChatApiSpec.SearchInfo;
import io.github.agentic.spring.ai.dashscope.chat.DashScopeChatApiSpec.SearchResult;
import io.github.agentic.spring.ai.dashscope.chat.DashScopeChatApiSpec.TokenUsage;
import io.github.agentic.spring.ai.dashscope.chat.DashScopeChatApiSpec.ToolCall;
...
class DashScopeChatModelTests {
    ...
    void testStreamErrorResponse() {
        ...
        when(dashScopeApi.chatCompletionStream(any(), any(), eq(false))).thenReturn(Flux.error(new io.github.agentic.spring.ai.dashscope.common.DashScopeException("InvalidParameter  (requestId: error-request-123)")));
