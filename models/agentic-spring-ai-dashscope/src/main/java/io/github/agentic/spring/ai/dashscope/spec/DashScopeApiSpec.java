...
package io.github.agentic.spring.ai.dashscope.spec;
...
public class DashScopeApiSpec {
    ...
    public record ChatCompletionMessage(
         ...
         */
        @JsonInclude(JsonInclude.Include.NON_NULL)
        public record MediaContent(@JsonIgnore @JsonProperty("type") String type, @JsonProperty("text") @Nullable String text,
                                   @JsonProperty("image") @Nullable String image,
                                   @JsonProperty("video") @Nullable Object video,
