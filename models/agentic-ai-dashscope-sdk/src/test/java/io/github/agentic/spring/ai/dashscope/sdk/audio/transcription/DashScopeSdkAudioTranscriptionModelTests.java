...
package io.github.agentic.spring.ai.dashscope.sdk.audio.transcription;
...
class DashScopeSdkAudioTranscriptionModelTests {
	...
	void testWrapsSubmitFailure() {
		...
		assertThatThrownBy(() -> model.call(prompt))
			.isInstanceOf(io.github.agentic.spring.ai.dashscope.sdk.common.DashScopeSdkException.class)
