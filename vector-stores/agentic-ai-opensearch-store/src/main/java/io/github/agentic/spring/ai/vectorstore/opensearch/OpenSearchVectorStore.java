 ...
 */
package io.github.agentic.spring.ai.vectorstore.opensearch;
...
public class OpenSearchVectorStore extends AbstractObservationVectorStore implements InitializingBean {
	 ...
	 */
	private final io.github.agentic.spring.ai.vectorstore.opensearch.OpenSearchApi openSearchApi;
	 ...
	 */
	private final Converter<JsonNode, io.github.agentic.spring.ai.vectorstore.opensearch.OpenSearchApi.SimilarityResult> itemConverter = new SimilarityResultConverter();
	 ...
	 * @param embeddingModel The embedding model used for vector operations.
	 */
	public OpenSearchVectorStore(io.github.agentic.spring.ai.vectorstore.opensearch.OpenSearchApi openSearchApi,
	...
	public List<Document> doSimilaritySearch(SearchRequest request) {
		...
		try {
			List<io.github.agentic.spring.ai.vectorstore.opensearch.OpenSearchApi.SimilarityResult> similarityResults = openSearchApi
	...
	public static class Builder extends AbstractVectorStoreBuilder<Builder> {
		 ...
		 * @param embeddingModel The embedding model used for vector operations.
		 */
		public Builder(io.github.agentic.spring.ai.vectorstore.opensearch.OpenSearchApi openSearchApi,
				EmbeddingModel embeddingModel) {
	...
	public static class SimilarityResultConverter
			implements Converter<JsonNode, io.github.agentic.spring.ai.vectorstore.opensearch.OpenSearchApi.SimilarityResult> {
		 ...
		 */
		@Override
		public io.github.agentic.spring.ai.vectorstore.opensearch.OpenSearchApi.SimilarityResult convert(
			...
			return new io.github.agentic.spring.ai.vectorstore.opensearch.OpenSearchApi.SimilarityResult(id, score, content,
					metadata);
		}
