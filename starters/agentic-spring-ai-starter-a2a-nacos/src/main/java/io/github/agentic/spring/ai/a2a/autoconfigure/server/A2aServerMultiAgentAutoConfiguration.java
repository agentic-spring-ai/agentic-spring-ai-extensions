...
package io.github.agentic.spring.ai.a2a.autoconfigure.server;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;

import io.github.agentic.spring.ai.a2a.autoconfigure.A2aAgentCardProperties;
import io.github.agentic.spring.ai.a2a.autoconfigure.A2aMultiAgentProperties;
import io.github.agentic.spring.ai.a2a.autoconfigure.A2aServerProperties;
import io.github.agentic.spring.ai.a2a.autoconfigure.server.condition.OnMultiAgentModeCondition;
import io.github.agentic.spring.ai.a2a.core.constants.A2aConstants;
import io.github.agentic.spring.ai.a2a.core.registry.AgentRegistry;
import io.github.agentic.spring.ai.a2a.core.registry.AgentRegistryService;
import io.github.agentic.spring.ai.a2a.core.route.MultiAgentJsonRpcRouterProvider;
import io.github.agentic.spring.ai.a2a.core.route.MultiAgentRequestRouter;
import io.github.agentic.spring.ai.a2a.core.server.A2aServerExecutorProvider;
import io.github.agentic.spring.ai.a2a.core.server.DefaultA2aServerExecutorProvider;
import io.github.agentic.spring.ai.a2a.core.server.GraphAgentExecutor;
import io.github.agentic.spring.ai.a2a.core.server.JsonRpcA2aRequestHandler;
import io.github.agentic.spring.ai.a2a.core.server.ServerTypeEnum;
import io.github.agentic.spring.ai.graph.agent.Agent;
import io.github.agentic.spring.ai.graph.agent.ReactAgent;
import io.github.agentic.spring.ai.graph.agent.a2a.A2aRemoteAgent;
