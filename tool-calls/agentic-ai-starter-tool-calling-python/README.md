# Agentic AI Python Tool Starter

This starter provides a Python Tool for Agentic AI agents that allows executing Python code using GraalVM polyglot.
...
<dependency>
    ...
    <artifactId>agentic-ai-starter-python-tool</artifactId>
    <version>${agentic-ai.version}</version>
</dependency>
```
