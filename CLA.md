...
### Agentic AI Extensions Project Contributor License Agreement

Thank you for your interest in contributing to the Agentic AI Extensions project ("the Project"). This Contributor License Agreement ("Agreement") documents the rights granted by contributors to the Project.
...
### Agentic AI Extensions 项目贡献者许可协议

感谢您有兴趣为 Agentic AI Extensions 项目（"本项目"）做出贡献。本贡献者许可协议（"协议"）记录了贡献者授予本项目的权利。
