...
<dependency>
    ...
    <artifactId>agentic-spring-ai-starter-document-reader-csdn</artifactId>
...
```bash
mvn -pl document-readers/agentic-spring-ai-starter-document-reader-csdn test -DskipITs
```
...
mvn -pl document-readers/agentic-spring-ai-starter-document-reader-csdn -Dtest=CsdnDocumentReaderIT test
```
