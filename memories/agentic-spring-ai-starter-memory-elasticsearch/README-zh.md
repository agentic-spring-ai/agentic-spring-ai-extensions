...
<dependency>
    ...
    <artifactId>agentic-spring-ai-starter-memory-elasticsearch</artifactId>
...
import io.github.agentic.spring.ai.memory.elasticsearch.ElasticsearchChatMemoryRepository;
