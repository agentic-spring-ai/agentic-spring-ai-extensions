...
final class PublicApiParity {
	...
	private static final String CORE_CLASS_NAME = "io.github.agentic.spring.ai.graph.node.KnowledgeRetrievalNode";

	private static final String EXTENSION_CLASS_NAME = "io.github.agentic.spring.ai.graph.node.rag.KnowledgeRetrievalNode";
	...
	private static String normalized(String value) {
		return value.replace(CORE_CLASS_NAME, EXTENSION_CLASS_NAME);
	}
