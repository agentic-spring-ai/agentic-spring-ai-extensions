# Agentic AI Autoconfigure RAG Elasticsearch Module
...
<dependency>
    ...
    <artifactId>agentic-ai-autoconfigure-rag-elasticsearch</artifactId>
...
```java
import io.github.agentic-ai.rag.preretrieval.transformation.HyDeTransformer;
import io.github.agentic-ai.rag.retrieval.search.HyDeRetriever;
